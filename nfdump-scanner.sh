...
command1='nfdump -R /home/netflow/logs/netflow/pfsense/ -s ip/bytes -s dstport:p/bytes -n 10'
command2="nfdump -R /home/netflow/logs/netflow/pfsense/ -c 10 'proto tcp and (dst port 80 or dst port 443) and not src host $firewall_lan and not src host $firewall_nat'"
command3="nfdump -R /home/netflow/logs/netflow/pfsense/ -O bytes -A srcip,proto,dstport -n 10 -o 'fmt:%sa -> %pr %dp %byt %fl'"
command4='nfdump -R /home/netflow/logs/netflow/pfsense/ -a -O tstart -n 10'
##################################
